...
public class RangeEnemyController : MonoBehaviour
{
    ...
    [SerializeField]
    private Transform groundCheck, wallCheck, arrowSpawnPoint;
    ...
    private AudioSource aliveAudiosource;
    ...
    private void Start()
    {
        ...
        if (aliveTransform != null)
        {
            ...
            aliveAudiosource = alive.GetComponent<AudioSource>();
        }
    ...
    public void TakeDamage(int damageAmount, float attackPositionX)
    {
        ...
        damageDirection = attackPositionX > alive.transform.position.x ? -1 : 1;
    ...
    private void UpdateDeadState()
    {
        ...
        {
            Instantiate(resourceDropPrefab, alive.transform.position, Quaternion.identity);
        }

        DeathCount.Instance?.EnemyDefeated();
    ...
    private void PlayAttackSound()
    {
        ...
        {
            aliveAudiosource.PlayOneShot(attack);
        }
    }
    ...
    private void PlayHurtSound()
    {
        if (aliveAudiosource != null)
        {
            aliveAudiosource.PlayOneShot(hurt);
        }
    }
